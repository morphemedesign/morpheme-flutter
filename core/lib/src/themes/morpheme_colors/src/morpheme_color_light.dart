...
final class MorphemeColorLight extends MorphemeColor {
  static final MorphemeColorLight _instance = MorphemeColorLight._();

  factory MorphemeColorLight() {
    return _instance;
  }

  MorphemeColorLight._();
  ...
  @override
  Color get grey1 => const Color(0xFFCFCFCF);
  @override
  Color get grey2 => const Color(0xFFE5E5E5);
  @override
  Color get grey3 => const Color(0xFFF5F5F5);
  @override
  Color get grey4 => const Color(0xFFF9F9F9);
  @override
